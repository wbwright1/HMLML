...
import { runPlayerWeekStatsBackfill } from "@/lib/sync/backfill-player-week-stats";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const summary = await runPlayerWeekStatsBackfill(seasonYear);
    ...
    console.error("[backfill-player-week-stats] Unhandled error:", message);
    return NextResponse.json(
