...
export const metadata = {
  title: "The GOAT Ladder | Harambe Memorial League Memorial League",
  description:
    "Every franchise ranked 1 to 12, all-time. Rings, records, and receipts, settled by one composite score. Somebody has to be twelfth.",
};
...
export default async function GoatLadderPage() {
    ...
    return (
      <>
        ...
        <EmptyState
          icon="trophy"
          title="No Ladder Yet"
          description="The GOAT Ladder ranks every franchise once season history has been synced from Sleeper."
    ...
    <>
      <section className="pt-8 pb-2 md:pt-12 space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-kicker">All-Time · The Ladder</p>
          <h1 className="text-display">The GOAT Ladder.</h1>
          <p className="text-body-lg text-text-secondary max-w-prose">
            Every franchise in league history, ranked 1 to {ladder.length} by one
            composite score. Rings, records, and receipts, all settled. Somebody
            has to be last.
          </p>
        </div>
      </section>
